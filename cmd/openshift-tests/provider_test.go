...
func TestDecodeProvider(t *testing.T) {
	var testCases = []struct {
	...
	}{
		{
			...
			expectedConfig:     `{"type":"gce","ProjectID":"openshift-gce-devel-ci","Region":"us-east1","Zone":"us-east1-a","NumNodes":3,"MultiMaster":true,"MultiZone":true,"Zones":["us-east1-a","us-east1-b","us-east1-c"],"ConfigFile":"","NetworkPlugin":"OpenShiftSDN","HasIPv4":true,"HasIPv6":false,"HasSCTP":false}`,
			runTests:           sets.NewString("everyone", "not-aws", "not-multitenant", "ipv4"),
		},
		{
			...
			expectedConfig:     `{"type":"gce","ProjectID":"openshift-gce-devel-ci","Region":"us-east1","Zone":"us-east1-a","NumNodes":3,"MultiMaster":true,"MultiZone":true,"Zones":["us-east1-a","us-east1-b","us-east1-c"],"ConfigFile":"","NetworkPlugin":"OpenShiftSDN","NetworkPluginMode":"Multitenant","HasIPv4":true,"HasIPv6":false,"HasSCTP":false}`,
			runTests:           sets.NewString("everyone", "not-aws", "ipv4"),
		},
		{
			...
			discoveredNetwork:  sdnConfig,
			expectedConfig:     `{"type":"skeleton","ProjectID":"","Region":"","Zone":"","NumNodes":3,"MultiMaster":true,"MultiZone":false,"Zones":[],"ConfigFile":"","NetworkPlugin":"OpenShiftSDN","HasIPv4":true,"HasIPv6":false,"HasSCTP":false}`,
			runTests:           sets.NewString("everyone", "not-gce", "not-aws", "not-multitenant", "ipv4"),
		},
		{
		...
		},
		{
			...
			discoveredMasters:  simpleMasters,
			discoveredNetwork:  sdnConfig,
			expectedConfig:     `{"type":"openstack","ProjectID":"","Region":"","Zone":"","NumNodes":3,"MultiMaster":true,"MultiZone":false,"Zones":[],"ConfigFile":"","NetworkPlugin":"OpenShiftSDN","HasIPv4":true,"HasIPv6":false,"HasSCTP":false}`,
			runTests:           sets.NewString("everyone", "not-gce", "not-aws", "not-multitenant", "ipv4"),
		},
		{
			...
			expectedConfig:     `{"type":"aws","ProjectID":"","Region":"us-east-2","Zone":"us-east-2a","NumNodes":3,"MultiMaster":false,"MultiZone":true,"Zones":[],"ConfigFile":"","NetworkPlugin":"OVNKubernetes","HasIPv4":true,"HasIPv6":true,"HasSCTP":false}`,
			runTests:           sets.NewString("everyone", "not-gce", "not-sdn", "not-multitenant", "ipv4", "ipv6", "dual-stack"),
		},
		{
			name:               "complex override without discovery",
			provider:           `{"type":"aws","region":"us-east-2","zone":"us-east-2a","multimaster":false,"multizone":true}`,
			discoveredPlatform: nil,
			expectedConfig:     `{"type":"aws","ProjectID":"","Region":"us-east-2","Zone":"us-east-2a","NumNodes":0,"MultiMaster":false,"MultiZone":true,"Zones":null,"ConfigFile":"","NetworkPlugin":"","HasIPv4":false,"HasIPv6":false,"HasSCTP":false}`,
		...
		},
		{
			...
			discoveredMasters:  simpleMasters,
			discoveredNetwork:  ovnKubernetesConfig,
			expectedConfig:     `{"type":"aws","ProjectID":"","Region":"us-east-2","Zone":"","NumNodes":3,"MultiMaster":true,"MultiZone":false,"Zones":[],"ConfigFile":"","NetworkPlugin":"Calico","HasIPv4":false,"HasIPv6":true,"HasSCTP":true}`,
			runTests:           sets.NewString("everyone", "not-gce", "not-sdn", "not-multitenant", "ipv6", "sctp"),
		},
	}
