...
type NodeConfig struct {
	...
	ProxyConfig *kproxy.ProxyServerConfig
...
func buildKubeProxyConfig(options configapi.NodeConfig) (*kproxy.ProxyServerConfig, error) {
	// get default config
	proxyconfig := kproxy.NewProxyConfig()
